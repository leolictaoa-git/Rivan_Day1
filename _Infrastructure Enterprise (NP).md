...
!@CoreTAAS
config t
 hostname CoreTAAS-41-(PLDT)
 Track 1 Int gi 0/1 line-protocol
 int vlan 1
  standby 1 ip 10.41.1.16
  standby 1 preempt
...
route add 10.0.0.0/8 via 10.41.1.4
route add 200.0.0.0/24 via 10.41.1.4
~~~
...
~~~
[realdevices]
ctaas ansible_host=10.41.1.2 ansible_user=admin ansible_password=pass
cbaba ansible_host=10.41.1.4 ansible_user=rivan ansible_password=C1sc0123
...
~~~
[real_cisco]
CTAAS ansible_host=10.41.1.2
CBABA ansible_host=10.41.1.4
CUCM ansible_host=10.41.100.8
EDGE ansible_host=10.41.41.1
